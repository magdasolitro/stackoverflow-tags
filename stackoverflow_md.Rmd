...
For example: 5, 12, 47, 6, 23 are the IDs of nodes belonging to group 8 (Apple development tags).
...
We investigate also the heterogeneity of different tags with some global similarity measure and show the results in a correlation plot.
