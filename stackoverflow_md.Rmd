...
## Community detection
Through community detection techniques, we can identify groups of tags that are more strongly connected to each other...
...
... and we realise that *nodes in the same group tend to represent technologies of similar domain*.
...
```{r group_display, echo=FALSE, include=TRUE, warning=FALSE, message=FALSE}

df <- data.frame()
list(group3,df, group7,df,group8) %>%
    kbl(align="lc", caption='On the left we have some caption, in the middel Angular2 is based on TypeScript and on the right Apple Development') %>%
...
# 
# group7 %>%
#     kbl(align="c", caption='Angular2 is based on TypeScript') %>%
#     kable_paper(bootstrap_options = "striped", full_width = FALSE) %>%
#     kable_styling(position = "center")
# 
# group8 %>%
#     kbl(align="c", caption='Apple Development') %>%
#     kable_paper(bootstrap_options = "striped", full_width = FALSE) %>%
...
<!-- Group 3 seems to comprehend technologies that are commonly used for ML applications. -->
<!-- ##### Two similar languages -->
<!-- **Angular 2** is based on **TypeScript**, thus it's easy to imagine why they are often found in the same post. -->
<!-- ##### Apple development -->
<!-- All of these technologies are used for the development of Apple products: **Objective-C** has been for a long time the primary programming language for writing software for **OS X** and **iOS**, while more recently **Swift** was introduced as an improvement of Objective-C. -->

## Plotting communities
We can plot communities with a histogram to compare the cardinality of each group.
